# Vue Designer PrimeVue - Quick start template

This is a starter template that pre-includes the [Pinegrow Vite Plugin](https://www.npmjs.com/package/@pinegrow/vite-plugin), [PrimeVue](https://primevue.org/introduction/), [Pinegrow PrimeVue Plugin](https://www.npmjs.com/package/@pinegrow/primevue-plugin) and other goodies for Vue Designer.

Demo - https://pg-vue-primevue.netlify.app/
...
[Create a repo from this template on GitHub](https://github.com/pinegrow/pg-vue-primevue/generate).
...
```bash
npx giget@latest gh:pinegrow/pg-vue-primevue my-vue-primevue-app #project-name
cd my-vue-primevue-app
...
```bash
npx giget@latest gh:pinegrow/pg-vue-primevue#minimal my-vue-primevue-app #project-name
cd my-vue-primevue-app
npm install #or use pnpm
```
...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/Pinegrow/pg-vue-primevue)
